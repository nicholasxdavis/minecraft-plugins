    ...
    public void perform(CommandContext context) {
        ...
        if (Conf.homesTeleportAllowedEnemyDistance > 0
            ...
            for (Player p : context.player.getServer().getOnlinePlayers()) {
                ...
                if (context.fPlayer.getRelationTo(fp) != Relation.ENEMY) {
                    continue;
                }
        ...
        // Use 8 seconds instead of 15
        long warmupSeconds = 8L;
        ...
        context.doWarmUp(WarmUpUtil.Warmup.HOME, TL.WARMUPS_NOTIFY_TELEPORT, "Home", () -> {
            ...
            // Send hook notification for successful teleport using reflection
                    ...
                    if (hookPlugin != null) {
                        ...
                        if (hookInstance != null) {
                            ...
                            if (hookAPI != null) {
                                ...
                                sendTitleMethod.invoke(hookAPI, context.player, 
                                    com.massivecraft.factions.util.PandoraMessage.highlight("Teleported!"),
                                    com.massivecraft.factions.util.PandoraMessage.text("Welcome home"));
                            }
                        }
                    }
                } catch (Exception e) {
                    // Hook plugin not available or reflection failed
                }
            }
        }, warmupSeconds);
    }
