    ...
    public void perform(CommandContext context) {
        ...
        FactionsPlugin.getInstance().getServer().getScheduler().runTaskAsynchronously(FactionsPlugin.instance, () -> {
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(FactionsPlugin.getInstance(), () -> {
                ...
                // Update beacon nametag if faction has a beacon
                if (context.faction.hasBeacon()) {
                    com.massivecraft.factions.util.BeaconNametagManager.updateNametag(context.faction);
                }
