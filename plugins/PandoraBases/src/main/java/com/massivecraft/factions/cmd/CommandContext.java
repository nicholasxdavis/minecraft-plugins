...
public class CommandContext {
    ...
    public void msg(String str, Object... args) {
        String message = TextUtil.parse(str, args);
        // Add Pandora prefix if message doesn't already have it
        if (!message.contains("Pandora") && !message.contains("»")) {
            message = com.massivecraft.factions.util.PandoraMessage.formatWithPrefix(message);
        }
        sender.sendMessage(message);
    }

    public void msg(TL translation, Object... args) {
        String message = TextUtil.parse(translation.toString(), args);
        // Add Pandora prefix if message doesn't already have it
        if (!message.contains("Pandora") && !message.contains("»")) {
            message = com.massivecraft.factions.util.PandoraMessage.formatWithPrefix(message);
        }
