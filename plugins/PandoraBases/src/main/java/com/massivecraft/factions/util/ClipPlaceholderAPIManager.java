    ...
    public String onPlaceholderRequest(Player player, String placeholder) {
        ...
        switch (placeholder) {
            ...
            case "player_lastseen":
                ...
                return fPlayer.isOnline() ? ChatColor.YELLOW + TL.COMMAND_STATUS_ONLINE.toString() : (System.currentTimeMillis() - fPlayer.getLastLoginTime() < 432000000 ? ChatColor.GRAY + humanized : ChatColor.RED + humanized);
            case "player_group":
