...
public class FCmdRoot extends FCommand implements CommandExecutor {
    ...
    public CmdBase cmdBase = new CmdBase();
    ...
    public FCmdRoot() {
        ...
        this.addSubCommand(this.cmdBase);
    ...
    public void perform(CommandContext context) {
        // If no arguments, check if player has a base and open GUI
        if (context.args.isEmpty()) {
            if (context.fPlayer != null && context.faction != null && 
                context.faction.isNormal() && context.faction.hasBeacon()) {
                // Player has a base - open base menu GUI
                com.massivecraft.factions.util.BeaconMenuGUI.openMenu(context.player, context.faction);
                return;
            } else if (context.fPlayer != null && (context.faction == null || !context.faction.hasBeacon())) {
                // Player doesn't have a base - show help or creation GUI
