...
public enum TL {
    ...
    COMMAND_CREATE_CREATED("&c&l[!]&7 &c%1$s &7has formed a base."),
    ...
    COMMAND_HOME_DISABLED("&e&lPandora &8» &r&7Sorry, Faction homes are &cdisabled &7on this server."),
    COMMAND_HOME_TELEPORTDISABLED("&e&lPandora &8» &r&7Sorry, the ability to &cteleport &7to Faction homes is &cdisabled &7on this server."),
    COMMAND_HOME_NOHOME("&e&lPandora &8» &r&7Your faction does &cnot &7have a home. "),
    COMMAND_HOME_UNSET("&e&lPandora &8» &r&7Sorry, your faction home has been &cun-set &7since it is no longer in your territory."),
    COMMAND_HOME_INENEMY("&e&lPandora &8» &r&7You &ccannot teleport &7to your &cfaction home &7while in the territory of an &cenemy faction&7."),
    COMMAND_HOME_WRONGWORLD("&e&lPandora &8» &r&7You &ccannot &7teleport to your &cfaction home &7while in a different world."),
    COMMAND_HOME_ENEMYNEAR("&e&lPandora &8» &r&7You &ccannot teleport &7to your faction home while an enemy is within &c%s &7blocks of you."),
    ...
    COMMAND_VERSION_NAME("&e&lPandora &8» &r &7&e&lPandoraBases &7- By Driftay"),
     ...
     * Warmups
     */
    WARMUPS_NOTIFY_FLIGHT("&7Flight will enable in &6%2$d &7seconds."),
    WARMUPS_NOTIFY_TELEPORT("&7You will teleport to &6%1$s &7in &6%2$d &7seconds."),
    WARMUPS_ALREADY("&e&lPandora &8» &r&7You are already warming up."),
    WARMUPS_CANCELLED("&e&lPandora &8» &r&7You have cancelled your warmup."),
