...
public class LevelManager {
    ...
    public LevelManager(FarmShop plugin) {
        this.plugin = plugin;
        setupLevelPlugin();
    }
    ...
    private void setupLevelPlugin() {
        ...
        try {
            ...
            if (apiInstance != null) {
                ...
                getLevelMethod = apiClass.getMethod("getLevel", java.util.UUID.class);
    ...
    public int getLevel(Player player) {
        ...
        try {
            Object result = getLevelMethod.invoke(levelPlugin, player.getUniqueId());
