# Build script for PandoraCrates
Write-Host "Building PandoraCrates..."
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "Build successful! JAR file is in the target directory."
    
    # Show JAR file location
    $jarFile = Get-ChildItem -Path "target" -Filter "PandoraCrates-*.jar" | Sort-Object LastWriteTime -Descending | Select-Object -First 1
