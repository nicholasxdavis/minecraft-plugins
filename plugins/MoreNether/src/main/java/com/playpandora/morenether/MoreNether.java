package com.playpandora.morenether;

import com.playpandora.morenether.handlers.*;
import org.bukkit.plugin.java.JavaPlugin;

public class MoreNether extends JavaPlugin {
    
    private static MoreNether instance;
    ...
    private com.playpandora.morenether.utils.IntegrationManager integrationManager;
    ...
    public void onEnable() {
        ...
        try {
            ...
            integrationManager = new com.playpandora.morenether.utils.IntegrationManager(this);
            
            // Initialize handlers
            getLogger().info("Initializing MoreNether handlers...");
            ...
            getLogger().info("MoreNether v" + getDescription().getVersion() + " has been enabled successfully!");
        } catch (Exception e) {
            getLogger().severe("Failed to enable MoreNether! " + e.getMessage());
            e.printStackTrace();
    ...
    public void onDisable() {
        try {
            ...
            getLogger().info("MoreNether has been disabled!");
        } catch (Exception e) {
    ...
    public static MoreNether getInstance() {
        return instance;
    }
    ...
    public com.playpandora.morenether.utils.IntegrationManager getIntegrationManager() {
