# Build script for PandoraOnevsOne
Write-Host "Building PandoraOnevsOne..." -ForegroundColor Cyan
...
if ($LASTEXITCODE -eq 0) {
    ...
    $jarFile = Get-ChildItem -Path "target" -Filter "PandoraOnevsOne-*.jar" | Sort-Object LastWriteTime -Descending | Select-Object -First 1
