package com.playpandora.morecaves;

import com.playpandora.morecaves.handlers.*;
import org.bukkit.plugin.java.JavaPlugin;

public class MoreCaves extends JavaPlugin {
    
    private static MoreCaves instance;
    ...
    private com.playpandora.morecaves.utils.IntegrationManager integrationManager;
    ...
    public void onEnable() {
        ...
        try {
            ...
            integrationManager = new com.playpandora.morecaves.utils.IntegrationManager(this);
            
            // Initialize handlers
            getLogger().info("Initializing MoreCaves handlers...");
            ...
            getLogger().info("MoreCaves v" + getDescription().getVersion() + " has been enabled successfully!");
        } catch (Exception e) {
            getLogger().severe("Failed to enable MoreCaves! " + e.getMessage());
            e.printStackTrace();
    ...
    public void onDisable() {
        try {
            ...
            getLogger().info("MoreCaves has been disabled!");
        } catch (Exception e) {
    ...
    public static MoreCaves getInstance() {
        return instance;
    }
    ...
    public com.playpandora.morecaves.utils.IntegrationManager getIntegrationManager() {
