# Build script for PandoraItems
Write-Host "Building PandoraItems..."
...
if ($LASTEXITCODE -eq 0) {
    ...
    $jarFile = Get-ChildItem -Path "target" -Filter "PandoraItems-*.jar" | Sort-Object LastWriteTime -Descending | Select-Object -First 1
