...
public class IVersion1_21_4 implements IVersion {
	...
	public Object spawn(Object entity) {
		...
		double x = RF.direct(entity, "dA", double.class);
		RF.access(m, "g", double.class).set(x);
		double y = RF.direct(entity, "dC", double.class);
		RF.access(m, "h", double.class).set(y);
		double z = RF.direct(entity, "dG", double.class);
