package com.pandora.spawners.text;
...
public final class Text {
	...
	public static void logLoad() {
		Bukkit.getConsoleSender().sendMessage(ChatColor.DARK_PURPLE + "[" + ChatColor.LIGHT_PURPLE + "PandoraSpawners " + ChatColor.AQUA + "v"
				+ PandoraSpawners.PLUGIN_VERSION + ChatColor.DARK_PURPLE + "]" + ChatColor.GREEN + " enabled!");
	}
	
	public static void logUnload() {
		Bukkit.getConsoleSender().sendMessage(ChatColor.DARK_PURPLE + "[" + ChatColor.LIGHT_PURPLE + "PandoraSpawners " + ChatColor.AQUA + "v"
				+ PandoraSpawners.PLUGIN_VERSION + ChatColor.DARK_PURPLE + "]" + ChatColor.RED + " disabled!");
	}
	...
	public static void logOutdated(double v) {
		Bukkit.getConsoleSender().sendMessage(ChatColor.DARK_PURPLE + "[" + ChatColor.LIGHT_PURPLE + "Spawner Meta "
				+ ChatColor.AQUA + "v" + PandoraSpawners.PLUGIN_VERSION + ChatColor.DARK_PURPLE + "] "
				+ ChatColor.YELLOW + "New version is available: v" + v + "! " + ChatColor.GOLD + "To download visit: "
				+ "https://www.spigotmc.org/resources/PandoraSpawners.74188/");
	}
	
	public static void logInfo(String info) {
		Bukkit.getConsoleSender().sendMessage(ChatColor.DARK_PURPLE + "[" + ChatColor.LIGHT_PURPLE + "PandoraSpawners"
				+ ChatColor.DARK_PURPLE + "] " + ChatColor.GRAY + info);
	}
	
	public static void logFail(String fail) {
		Bukkit.getConsoleSender().sendMessage(ChatColor.DARK_PURPLE + "[" + ChatColor.LIGHT_PURPLE + "PandoraSpawners " + ChatColor.AQUA + "v"
				+ PandoraSpawners.PLUGIN_VERSION + ChatColor.DARK_PURPLE + "] " + ChatColor.DARK_RED + fail);
	}
