package com.pandora.spawners.version.types;
...
import com.pandora.spawners.version.IVersion;

public class IVersion1_15_1 implements IVersion {
	...
	public void send(Collection<? extends Player> players, Object... os) {
		players.forEach(player -> {
			...
			Class<?> c = RF.get("net.minecraft.server.v1_15_R1.Packet");
	...
	public Object spawn(Object entity) {
		...
		Class<?> a = RF.get("net.minecraft.server.v1_15_R1.PacketPlayOutSpawnEntityLiving");
		
		Class<?> b = RF.get("net.minecraft.server.v1_15_R1.EntityLiving");
	...
	public Object meta(Object entity) {
		...
		Class<?> a = RF.get("net.minecraft.server.v1_15_R1.PacketPlayOutEntityMetadata");

		int b = RF.direct(entity, "getId", int.class);
		
		Object c = RF.direct(entity, "getDataWatcher");
		
		Class<?> d = RF.get("net.minecraft.server.v1_15_R1.DataWatcher");
	...
	public Object destroy(Object entity) {
		...
		Class<?> a = RF.get("net.minecraft.server.v1_15_R1.PacketPlayOutEntityDestroy");
	...
	public Object hologram(Location l, String name) {
		...
		Class<?> a = RF.get("net.minecraft.server.v1_15_R1.World");
		
		Object b = RF.direct(l.getWorld(), "getHandle");
		
		Class<?> c = RF.get("net.minecraft.server.v1_15_R1.EntityArmorStand");
	...
	public void name(Object entity, String name) {
		...
		Class<?> a = RF.get("net.minecraft.server.v1_15_R1.IChatBaseComponent");
