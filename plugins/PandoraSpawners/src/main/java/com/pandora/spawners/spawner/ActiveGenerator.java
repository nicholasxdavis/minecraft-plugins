...
import com.pandora.spawners.api.events.SpawnerPostSpawnEvent;
import com.pandora.spawners.api.events.SpawnerPreSpawnEvent;
import com.pandora.spawners.api.hologram.IHologram;
import com.pandora.spawners.api.region.IBox;
...
import com.pandora.spawners.api.spawner.location.IFinder;
import com.pandora.spawners.api.spawner.location.ISelector;
...
import com.pandora.spawners.spawner.requirement.ActiveFinder;
...
import com.pandora.spawners.view.ActiveUpgrades;
...
public class ActiveGenerator implements IGenerator {
	...
	@Override
	public void tick() {
		PandoraSpawners.scheduler().runAtLocation(spawner.block().getLocation(), task -> {
