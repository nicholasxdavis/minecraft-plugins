...
import com.pandora.spawners.api.spawner.requirement.ILight;
import com.pandora.spawners.api.spawner.requirement.IMaterial;
import com.pandora.spawners.api.spawner.requirement.IRequirements;
import com.pandora.spawners.api.spawner.requirement.IRequirements.Builder;
...
public class RequirementFile extends AbstractFile {
	...
	protected void initialize() {
		...
		put(SpawnerType.COPPER_GOLEM, "", air, solid);
		...
		put(SpawnerType.PIGLIN_BRUTE, "-4", air, "", true);
		...
		put(SpawnerType.RAVAGER, "-4", air, "", true);
		...
		put(SpawnerType.SPIDER, "-4", air, "", true);
		...
		put(SpawnerType.VEX, "-4", air, "", true);
		put(SpawnerType.VILLAGER, "9+", air, solid);
		put(SpawnerType.VINDICATOR, "-4", air, "", true);
		put(SpawnerType.WANDERING_TRADER, "7+", air, solid);
		put(SpawnerType.WARDEN, "-4", air, "", true);
		put(SpawnerType.WITCH, "-4", air, "", true);
		put(SpawnerType.WITHER, "-4", air, "", true);
