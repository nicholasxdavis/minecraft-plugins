...
import com.pandora.spawners.view.layout.ActiveBackground;
import com.pandora.spawners.view.layout.ActiveSlot;
...
public class LayoutsFile extends AbstractFile {
	...
	protected void initialize() {
		if(CF.version() < 6) {
			var of = new File(PandoraSpawners.instance().getDataFolder(), "layout.yml");
			if(of.exists() == true) {
				try {
