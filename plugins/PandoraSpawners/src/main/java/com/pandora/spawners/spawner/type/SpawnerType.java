package com.pandora.spawners.spawner.type;
...
import com.pandora.spawners.utility.region.EntityBox;
import com.pandora.spawners.utility.region.IEntityMulitbox;
...
public enum SpawnerType {
	...
	HORSE(EntityType.HORSE, "Horse", Material.HORSE_SPAWN_EGG, EntityBox.box(2, 2, 2)),
	...
	MINECART_SPAWNER(_e("MINECART_MOB_SPAWNER", "SPAWNER_MINECART"), "Minecart with Spawner", null, EntityBox.single()),
	...
	SKELETON_HORSE(EntityType.SKELETON_HORSE, "Skeleton Horse", Material.SKELETON_HORSE_SPAWN_EGG, EntityBox.box(2, 2, 2)),
	...
	SNOWMAN(_e("SNOWMAN", "SNOW_GOLEM"), "Snowman", _m("SNOW_GOLEM_SPAWN_EGG"), EntityBox.box(1, 2, 1)),
	...
	public Content formated() {
		return Language.or("Entities.name." + name(), text());
	}
